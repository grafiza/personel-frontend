                ...
                <tbody>
                    {leaves.map(leave => (
                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 hover:text-blue-rgb"
                            key={leave.id}>
                            <td scope="row" className="px-6 py-4 font-bold whitespace-nowrap">{leave.employee.firstName} {leave.employee.lastName}</td>
                            ...
                            <td className="flex items-center px-6 py-4"><Link href={`/leave/edit/${leave.id}`} ><FaPen /></Link>&nbsp;&nbsp;<DeleteLeave id={leave.id} />
                            </td>
                        </tr>
                    ))}
                </tbody>
